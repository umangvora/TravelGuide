			...
			<div class="row">
				<div class="col">
					...
					<div class="contact_form_container">
						...
						<form action="reg.php" method="post" id="contact_form" class="contact_form text-center">
							<input type="text" name="user" id="contact_form_email" class="contact_form_email input_field" placeholder="Name" required="required" data-error="Email is required.">
